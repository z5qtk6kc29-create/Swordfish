...
#Here I will split the words into lists of strings for each letter
def split_words(computer_choice, user_choice):
    computer_list = list(computer_choice)
    user_list = list(user_choice)
    return computer_list, user_list
...
play()
computer_choice, user_choice = words()
computer_list, user_list = split_words(computer_choice, user_choice)
check_win(computer_list, user_list)

###

#Here is a function that allows the user to play the second time
def second_chance(word_options_as_list):
    user_choice2 = input("\nTry a different word: ")
    if user_choice2 not in word_options_as_list:
        print("That word is invalid")
        return second_chance(word_options_as_list)
    else:
        user_list2 = list(user_choice2)
        return user_list2

#Here is where we can see how the user did on the second attempt
def check_win2(computer_list, user_list2):
    if user_list2 == computer_list:
        sys.exit("\nYou have found the wordle!")
    else:
        for l in range(len(user_list2)):
            if user_list2[l] == computer_list[l]:
                print(user_list2[l] + " is the correct letter!")
            elif user_list2[l] in computer_list:
                print(user_list2[l] + " is in the wrong position")
            else:
                print(user_list2[l] + " is not in the word")

#Here is where we call the functions for the second attempt
user_list2 = second_chance(word_options_as_list)
check_win2(computer_list, user_list2)

###

#Here is a function that allows the user to play a third time
def third_chance(word_options_as_list):
    user_choice3 = input("\nTry a different word: ")
    if user_choice3 not in word_options_as_list:
        print("That word is invalid")
        return second_chance(word_options_as_list)
    else:
        user_list3 = list(user_choice3)
        return user_list3

#Here is where we can see how the user did on the third attempt
def check_win3(computer_list, user_list3):
    if user_list3 == computer_list:
        sys.exit("\nYou have found the wordle!")
    else:
        for l in range(len(user_list3)):
            if user_list3[l] == computer_list[l]:
                print(user_list3[l] + " is the correct letter!")
            elif user_list3[l] in computer_list:
                print(user_list3[l] + " is in the wrong position")
            else:
                print(user_list3[l] + " is not in the word")

#Here is where we call the functions for the third attempt
user_list3 = third_chance(word_options_as_list)
check_win3(computer_list, user_list3)

###

#Here is a function that allows the user to play a fourth time
def fourth_chance(word_options_as_list):
    user_choice4 = input("\nTry a different word: ")
    if user_choice4 not in word_options_as_list:
        print("That word is invalid")
        return second_chance(word_options_as_list)
    else:
        user_list4 = list(user_choice4)
        return user_list4

#Here is where we can see how the user did on the fourth attempt
def check_win4(computer_list, user_list4):
    if user_list4 == computer_list:
        sys.exit("\nYou have found the wordle!")
    else:
        for l in range(len(user_list4)):
            if user_list4[l] == computer_list[l]:
                print(user_list4[l] + " is the correct letter!")
            elif user_list4[l] in computer_list:
                print(user_list4[l] + " is in the wrong position")
            else:
                print(user_list4[l] + " is not in the word")

#Here is where we call the functions for the third attempt
user_list4 = fourth_chance(word_options_as_list)
check_win4(computer_list, user_list4)

###

#Here is a function that allows the user to play a fifth time
def fifth_chance(word_options_as_list):
    user_choice5 = input("\nTry a different word: ")
    if user_choice5 not in word_options_as_list:
        print("That word is invalid")
        return second_chance(word_options_as_list)
    else:
        user_list5 = list(user_choice5)
        return user_list5

#Here is where we can see how the user did on the third attempt
def check_win5(computer_list, user_list5):
    if user_list5 == computer_list:
        sys.exit("\nYou have found the wordle!")
    else:
        for l in range(len(user_list5)):
            if user_list5[l] == computer_list[l]:
                print(user_list5[l] + " is the correct letter!")
            elif user_list5[l] in computer_list:
                print(user_list5[l] + " is in the wrong position")
            else:
                print(user_list5[l] + " is not in the word")

#Here is where we call the functions for the third attempt
user_list5 = fifth_chance(word_options_as_list)
check_win5(computer_list, user_list5)

###

#Here is a function that allows the user to play a sixth time
def sixth_chance(word_options_as_list):
    user_choice6 = input("\nTry a different word: ")
    if user_choice6 not in word_options_as_list:
        print("That word is invalid")
        return second_chance(word_options_as_list)
    else:
        user_list6 = list(user_choice6)
        return user_list6

#Here is where we can see how the user did on the third attempt
def check_win6(computer_list, user_list6, computer_choice):
    if user_list6 == computer_list:
        sys.exit("\nYou have found the wordle!")
    else:
        for l in range(len(user_list6)):
            if user_list6[l] == computer_list[l]:
                print(user_list6[l] + " is the correct letter!")
            elif user_list6[l] in computer_list:
                print(user_list6[l] + " is in the wrong position")
            else:
                print(user_list6[l] + " is not in the word")
        sys.exit("\nUnfortunately, you have not gotten it. Thanks for playing! The correct word was: " + computer_choice)

#Here is where we call the functions for the sixth attempt
user_list6 = sixth_chance(word_options_as_list)
check_win6(computer_list, user_list6, computer_choice)